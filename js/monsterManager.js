...
export class MonsterManager {
  ...
  addAttackToMonster(monId, attackId) {
    ...
    // Dynamically update the modal content if the monster sheet is open
    if (this.app.uiManager.monsterSheetModal.style.display === 'block') {
      this.app.uiManager.renderAttacksSection(template, 'monster', document.getElementById('monster-attacks'));
    }
  }
